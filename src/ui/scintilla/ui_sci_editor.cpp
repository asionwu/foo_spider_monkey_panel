...
void CScriptEditorCtrl::Init()
{
	...
	SetProperty("dir.base", (smp::path::Foobar2000() / "").u8string().c_str());
	SetProperty("dir.component", (smp::path::Component() / "").u8string().c_str());
	SetProperty("dir.profile", (smp::path::Profile() / "").u8string().c_str());
